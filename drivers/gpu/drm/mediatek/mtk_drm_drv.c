...
static const enum mtk_ddp_comp_id mt6735_mtk_ddp_main[] = {
	DDP_COMPONENT_OVL0,
	DDP_COMPONENT_COLOR0,
...
static const struct mtk_mmsys_match_data mt6735_mmsys_match_data = {
	.num_drv_data = 1,
	.drv_data = {
		&mt6735_mmsys_driver_data,
	},
};
