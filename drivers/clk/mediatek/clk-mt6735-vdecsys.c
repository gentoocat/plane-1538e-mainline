...
static const struct mtk_gate vdecsys_gates[] = {
	GATE_MTK(VDEC, "vdec", "vdec_sel", &vdec_cg_regs, 0, &mtk_clk_gate_ops_setclr_inv),
	GATE_MTK(SMI_LARB1, "smi_larb1", "vdec_sel", &smi_larb1_cg_regs, 0, &mtk_clk_gate_ops_setclr_inv),
};

static u16 vdecsys_rst_ofs[] = { VDEC_RESETB_CON, SMI_LARB1_RESETB_CON };

static const struct mtk_clk_rst_desc vdecsys_resets = {
	.version = MTK_RST_SIMPLE,
	.rst_bank_ofs = vdecsys_rst_ofs,
	.rst_bank_nr = ARRAY_SIZE(vdecsys_rst_ofs)
};
